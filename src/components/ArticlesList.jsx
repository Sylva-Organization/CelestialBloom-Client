...
const ArticlesList = ({ users }) => {
    //AQUÍ NO HAY QUE PASAR NINGÚN MÉTODO


    // post botánica
    // const botanyPosts = users.map(user => 
    //     user.posts.filter(post => post.categories.name.toLowerCase() === "botánica")
    // )

    // posts astronomía
    // const astronomyPosts = users.map(user => 
    //     user.posts.filter(post => post.categories.name.toLowerCase() === "astronomía")
    // )
